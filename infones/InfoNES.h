...
enum Ppu2007Mode
{
  PPU2007_MODE_STOCK = 0,
  PPU2007_MODE_RENDER_ADDR_LOWBYTE = 1,
  PPU2007_MODE_RENDER_LOWBYTE_AND_SCROLL = 2,
};

constexpr Ppu2007Mode kPpu2007Mode = PPU2007_MODE_STOCK;
/*-------------------------------------------------------------------*/
/*  NES resources                                                    */
/*-------------------------------------------------------------------*/
...
/* Header identity used by board-specific mapper selection. */
extern BYTE ROM_NES2;
extern BYTE ROM_Submapper;
