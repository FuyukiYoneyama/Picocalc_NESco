...
/*
 * Mapper 235 is enabled in the mapper table. Current code only touches
 * the first 0x2000 bytes of DRAM, so dynamic allocation uses that size.
 */
#define PICOCALC_ENABLE_MAPPER235 1
#define DRAM_SIZE 0x2000

#define MAP6_CHR_RAM_SIZE 0x8000

/*-------------------------------------------------------------------*/
/*  Mapper resources                                                 */
/*-------------------------------------------------------------------*/

/* Shared mapper work RAM */
extern BYTE *DRAM;
...
void InfoNES_Mapper_ReleaseCurrent();
