...
static BYTE *Map185_Dummy_Chr_Rom_Alloc = nullptr;

void Map185_Release()
{
  delete[] Map185_Dummy_Chr_Rom_Alloc;
  Map185_Dummy_Chr_Rom_Alloc = nullptr;
...
void Map185_Init()
{
  ...
  Map185_Release();
  Map185_Dummy_Chr_Rom_Alloc = new (std::nothrow) BYTE[0x0400];
  if (!Map185_Dummy_Chr_Rom_Alloc)
  {
    InfoNES_Error("Mapper 185 startup alloc failed [1/1 dummy-chr size=%u]", 0x0400);
    Map185_Release();
    return;
  }
  Map185_Dummy_Chr_Rom = Map185_Dummy_Chr_Rom_Alloc;
