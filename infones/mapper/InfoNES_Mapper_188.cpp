...
static BYTE *Map188_Dummy_Alloc = nullptr;

void Map188_Release()
{
  delete[] Map188_Dummy_Alloc;
  Map188_Dummy_Alloc = nullptr;
...
void Map188_Init()
{
  ...
  Map188_Release();
  Map188_Dummy_Alloc = new (std::nothrow) BYTE[0x2000];
  if (!Map188_Dummy_Alloc)
  {
    InfoNES_Error("Mapper 188 startup alloc failed [1/1 dummy size=%u]", 0x2000);
    Map188_Release();
    return;
  }
  Map188_Dummy = Map188_Dummy_Alloc;
